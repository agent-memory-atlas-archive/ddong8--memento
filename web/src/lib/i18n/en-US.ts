...
const enUS: Translations = {
  ...
  persona: {
    ...
    subtitle: "The \"about me\" every AI tool loads at startup. Drafted nightly from what you typed; written to tools only after you publish.",
    published: "Published",
    draft: "Draft for review",
    noPublished: "No profile published yet.",
    noDraft: "No new draft. One is generated after nightly dreaming, or generate one now.",
    regenerate: "Generate draft now",
    regenerating: "Generating…",
    unchanged: "Same as the published profile; nothing new.",
    noInput: "Not enough input from the last 30 days to draft a profile.",
    llmFailed: "Generation failed: the AI service is unavailable. Try again later.",
    noLlm: "No AI service is configured on the server. You can still edit and publish by hand.",
    userEditing: "You've edited the current draft. Publish or discard it before regenerating.",
    edit: "Edit",
    save: "Save draft",
    cancel: "Cancel",
    publish: "Publish",
    ...
    editedHint: "You edited this draft; nightly generation won't overwrite it.",
    diffTitle: "Changes vs. published",
    added: "Added",
    removed: "Removed",
    devicesTitle: "Write into which tools",
    devicesHint: "Enable per device. Turning one off removes the block on the next sync (within 5 min); files Memento created are deleted.",
    offline: "offline",
    noDevices: "No registered devices yet.",
    statusWritten: "Written",
    statusUnchanged: "Up to date",
    statusRemoved: "Removed",
    statusSkipped: "Not installed",
    statusWaiting: "Awaiting publish",
    statusError: "Error",
    statusPending: "Pending sync",
    reportedAt: "Last sync",
    version: "Version",
    voiceStats: "Based on {kept} things you typed ({corrections} corrections) and {memories} preference/rule memories",
  },
  ...
  ask: {
    ...
    executing: "Executing task on device…",
    sources: "Sources",
    empty: "Ask a question from memory, or dispatch commands and agent tasks to your machines.",
    clear: "Clear",
    historyTitle: "Chat History",
    newChat: "New Chat",
    deleteConfirm: "Are you sure you want to delete this conversation?",
    noHistory: "No conversation history",
    turnsCount: "{n} messages",
    error: "Generation failed, please retry",
    noSources: "No relevant material found",
    stop: "Stop",
    deviceSelector: "Target Device",
    autoDispatch: "🤖 Auto Dispatch (AI selects device)",
    askOnly: "💭 Memory Only (No execution)",
    online: "online",
    offline: "offline",
    cwdLabel: "Working dir",
    cwdPlaceholder: "e.g. ~/dev/memento (optional)",
    statusQueued: "Queued",
    ...
    copied: "Copied",
    toggleOutput: "Toggle details",
    quickSuggestions: "Quick Commands",
    sugGitStatus: "Check git status and changes on device",
  ...
  admin: {
    ...
    collectorUpToDate: "Up to date",
    updateToVersion: "Update to v{version}",
    updateNotifiedVersion: "Notified {name} to upgrade to v{version}",
