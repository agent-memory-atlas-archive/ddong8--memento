const zhCN = {
  ...
  persona: {
    title: "常驻画像",
    subtitle: "每次打开 AI 工具时自动加载的「关于我」。每晚根据你亲口说的话生成草稿，你发布后才会写进各工具。",
    published: "已发布",
    draft: "待审草稿",
    noPublished: "还没有发布过画像。",
    noDraft: "暂无新草稿。每晚做梦后会自动生成，也可以现在生成一份。",
    regenerate: "现在生成草稿",
    regenerating: "生成中…",
    unchanged: "和已发布的画像一致，没有新内容。",
    noInput: "最近 30 天没有足够的输入来生成画像。",
    llmFailed: "生成失败：AI 服务暂时不可用，稍后再试。",
    noLlm: "服务端没有配置 AI 服务，无法生成草稿。你可以手动编辑后发布。",
    userEditing: "你改过当前草稿。先发布或丢弃它，再重新生成。",
    edit: "编辑",
    save: "保存草稿",
    cancel: "取消",
    publish: "发布",
    publishing: "发布中…",
    discard: "丢弃草稿",
    editedHint: "你改过这份草稿，夜间生成不会覆盖它。",
    diffTitle: "与已发布版本的差异",
    added: "新增",
    removed: "删除",
    devicesTitle: "写入哪些工具",
    devicesHint: "按设备单独开启。关闭后，collector 会在下一次同步（5 分钟内）把这段删掉；文件是 Memento 新建的会整个删除。",
    offline: "离线",
    noDevices: "还没有注册的设备。",
    statusWritten: "已写入",
    ...
    reportedAt: "上次同步",
    version: "版本",
    voiceStats: "依据：{kept} 条你亲口说的话（{corrections} 条纠正）、{memories} 条偏好/铁律记忆",
  },
  ...
  ask: {
    ...
    executing: "正在设备上执行任务…",
    sources: "参考资料",
    empty: "你可以向记忆库提问，也可以直接给设备派发命令或任务。",
    clear: "清空对话",
    historyTitle: "历史对话",
    newChat: "新建对话",
    ...
    stop: "停止",
    deviceSelector: "执行设备",
    autoDispatch: "🤖 自动调度 (AI 决定设备)",
    askOnly: "💭 仅查记忆 (不执行命令)",
    online: "在线",
    offline: "离线",
    cwdLabel: "工作目录",
    cwdPlaceholder: "例如: ~/dev/memento (可选)",
    statusQueued: "排队中",
    statusRunning: "执行中",
    ...
    copied: "已复制",
    toggleOutput: "查看详情",
    quickSuggestions: "快捷指令推荐",
    sugGitStatus: "在设备上检查 git 状态与变更",
  ...
  admin: {
    ...
    collectorUpToDate: "已最新",
    updateToVersion: "更新到 v{version}",
    updateNotifiedVersion: "已通知 {name} 升级到 v{version}",
