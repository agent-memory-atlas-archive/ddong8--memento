...
export const FALLBACK_AGENT_MODELS: Record<string, Array<{ id: string; name: string; desc?: string }>> = {
  ...
  claude: [
    ...
    { id: "sonnet", name: "sonnet (官方动态最新 Sonnet 别名)", desc: "自动映射当前官方最新 Sonnet (Claude 3.7 Sonnet / Sonnet 4.5)" },
    { id: "opus", name: "opus (官方动态最新 Opus 别名)", desc: "高阶架构与超大上下文 (Claude Opus 4.1 / Opus 4)" },
    { id: "haiku", name: "haiku (官方动态最新 Haiku 别名)", desc: "极速轻量日常模型 (Claude Haiku 4.5 / 3.5 Haiku)" },
    { id: "opus[1m]", name: "opus[1m] (100万上下文增强版)", desc: "超大上下文深度思维推演" },
    { id: "claude-3-7-sonnet-20250219", name: "claude-3-7-sonnet-20250219 (Claude 3.7 Sonnet)", desc: "最新混合推理与编码模型" },
