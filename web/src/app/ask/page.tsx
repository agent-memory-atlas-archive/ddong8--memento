...
export const FALLBACK_AGENT_MODELS: Record<string, Array<{ id: string; name: string; desc?: string }>> = {
  ...
  claude: [
    ...
    { id: "sonnet", name: "sonnet (官方动态最新 Sonnet 别名)", desc: "自动映射当前官方最新 Sonnet (当前为 Claude Sonnet 4.6)" },
    { id: "opus", name: "opus (官方动态最新 Opus 别名)", desc: "高阶架构与超大上下文 (当前为 Claude Opus 4.6)" },
    ...
    { id: "claude-opus-4-6", name: "claude-opus-4-6 (Claude Opus 4.6)", desc: "官方顶级旗舰架构设计与复杂推演模型" },
    { id: "claude-sonnet-4-6", name: "claude-sonnet-4-6 (Claude Sonnet 4.6)", desc: "官方最新主力编码与推理模型 (当前主力)" },
